...
class Customers_List_Table extends WP_List_Table {
    ...
    public function __construct() {
        parent::__construct( array(
            'singular' => __( 'Customer', 'appzcoder' ),
            'plural'   => __( 'Customers', 'appzcoder' ),
            'ajax'     => false
        ) );
    }
    ...
    public function no_items() {
        _e( 'No customers avaliable.', 'appzcoder' );
    }
...
case 'city':
    ...
    function get_columns() {
        $columns = [
            ...
            'name' => __( 'Name', 'appzcoder' ),
'email' => __( 'Email', 'appzcoder' ),
'address' => __( 'Address', 'appzcoder' ),
'city' => __( 'City', 'appzcoder' ),
...
'city' => array( 'city', true ),
    ...
    public function prepare_items() {
        ...
        $total_items  = ac_get_customers( $args );
        ...
        $this->items = ac_get_customers( $args );
    }
}